<html moznomarginboxes mozdisallowselectionprint>
    <head>
        <title>ApoBase - Print Nota</title>
        <style type="text/css">
    ...
    <body onload="window.print()">
        <div class="content">
            <div class="title">
                <b>APOBASE</b>
                <br>
                JL. Banyuwangi No.2 Garahan Silo
            </div>
            ...
            <div class="transaction">
                <table class="transaction-table" cellspacing="0" cellpadding="0">
                    <?php
                        ...
                        <tr>
                            <td colspan="2"></td>
                            <td style="text-align:right; padding-top:20px;">Sub Total</td>
                        ...
                        <tr>
                            ...
                            <td style="border-top: 1px dashed; text-align:right; padding-top:5px"><?=indo_currency($sale->final_price)?></td>
                        </tr>
                        <tr>
                            <td colspan="2"></td>
                        ...
                        <tr>
                            ...
                            <td style="border-top: 1px dashed; text-align:right; padding-top:5px"><?=$sale->remaining?></td> 
                        </tr>
                </table>
            </div>
            <div class="thanks">
