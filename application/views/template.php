...
<head>
  ...
  <title>AplikasiKu - by Kelompok1</title>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview <?= $this->uri->segment(1) == 'stock' || $this->uri->segment(1) == 'sale' ? 'active' : ''?>">
            ...
            <ul class="treeview-menu">
                ...
                <!-- Setiap ingin menambahkan ini kita harus mengubah atau mengcustom linknya di dalam folder config di dalam file route, silahkan liat penjelasannya di file tersebut -->
